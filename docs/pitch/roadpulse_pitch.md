...
| **Total ARR** | | | **$1.0M** | **$15.6M** |

(Честная переоценка $30M → $15.6M на год 3 — см. часть 3, weak spot #4.)

> **Note:** RoadPulse рендерит CO₂ оценку по маршруту как user-facing eco-hint в B2C app. Это **не отдельный revenue stream и не verified-emissions feed** — методология verified avoided emissions для eco-routing на 2025 не утверждена ни одним международным реестром, а privacy-by-design контракт RoadPulse запрещает собирать GPS-треки уровня драйвера, необходимые для counterfactual baseline.
